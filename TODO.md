...
| # | 任务 | 描述 | 预估 |
|:-:|------|------|:----:|
| 4 | 依赖图分析 | 程序集/类型级依赖关系，输出 Mermaid 格式 | 4h |
| 5 | 控制流图 (CFG) | 方法内基本块识别、分支指令分析、Mermaid 输出 | 6h |
| 6 | E2E 测试补全 | 完善 `docker-compose-e2e.yml` 下的自动化测试 | 2h |
...
| # | 任务 | 描述 | 预估 |
|:-:|------|------|:----:|
| 7 | 设计模式检测 | 单例/工厂/观察者模式自动识别 | 4h |
| 8 | 混淆检测 | 非法标识符、控制流平坦化特征检测 | 4h |
| 9 | 批量代码下载 | ZIP 打包下载多个类型/方法源码 | 2h |
